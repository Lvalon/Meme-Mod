...
{
	public sealed class cardiwoption1Def : lvalonmemecardtemplate
	{
	...
	[EntityLogic(typeof(cardiwoption1Def))]
	public sealed class cardiwoption1 : OptionCard
	{
		// 从回合开始多抽1张牌
		public override IEnumerable<BattleAction> TakeEffectActions()
		{
			yield return new ApplyStatusEffectAction<seicewingplus1>(Battle.Player, Value1);
		}
	}
}
